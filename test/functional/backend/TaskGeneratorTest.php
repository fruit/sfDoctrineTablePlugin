<?php
  ...
  $returnCode = $task->run(array(), array('depth' => 1, 'env' => 'test', 'generator-class' => 'TestTableGenerator', 'no-confirmation' => true));
  ...
  $returnCode = $task->run(array(), array('depth' => 3, 'env' => 'test', 'no-confirmation' => true));
