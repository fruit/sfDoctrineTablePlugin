[?php
   ...
   *
   * This class was auto-generated by the sfDoctrineTablePlugin's task:
   *
   *    ./symfony doctrine:build-table<?php print ($this->params['minified'] ? ' --minified' : '') ?> --env=<?php print $this->params['env'] ?> --depth=<?php print (1 + $this->params['depth']) . PHP_EOL ?>
   *
...
<?php endforeach; ?>
  ...
  {
    /**
     * @return string Base table class name (for late-static-bindings purposes)
     */
